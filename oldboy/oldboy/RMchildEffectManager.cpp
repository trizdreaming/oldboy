...
void CRMchildEffectManager::GetStartPosition( PlayerNumber targetPlayer, float* x, float* y ) //SM9: 출력용은 OUT 붙여주고, default 일 경우는 return false 하거나 x=y=0 처럼 뭔가 밖에서 알 수 있게 에러 처리 할 것
{
	switch ( targetPlayer )
	{
	case PLAYER_ONE:
