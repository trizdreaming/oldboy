...
void CRMresultManager::ShowResult()
{
	...
	p1Score->CreateLabel( L"p1Score" , string2wstring( std::to_string( player1->GetCount(COUNT_SCORE) ) ), LABEL_FONT_NORMAL, 35.0f );
	...
	p2Score->CreateLabel( L"p2Score" , string2wstring( std::to_string( player2->GetCount(COUNT_SCORE) ) ), LABEL_FONT_NORMAL, 35.0f );
